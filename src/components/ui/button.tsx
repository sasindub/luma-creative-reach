  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-medium ring-offset-background transition-smooth focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        ...
        hero: "gradient-primary text-white font-semibold shadow-glow hover:scale-105 transition-bounce border-0",
        gradient: "gradient-hero text-white font-medium hover:opacity-90 border-0",
        glass: "bg-white/10 text-white border border-white/20 backdrop-blur-sm hover:bg-white/20",
        luma: "bg-luma-primary text-white hover:bg-luma-secondary transition-smooth font-medium",
      },
      size: {
